...
3. Open the page in your browser: [http://localhost:8080/swagger-ui/index.html](http://localhost:8080/swagger-ui/index.html). On this page you can use all public endpoints of the project.
...
4. If you keep seeing red classes in the code, then go to the target folder and mark these directories as "Generated Sources Root". [See screenshot](./readme_resources/project_structure_help.png)
