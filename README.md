...
4. Open the page in your browser: [http://localhost:8080/swagger-ui/index.html](http://localhost:8080/swagger-ui/index.html). On this page you can use all public endpoints of the project.
